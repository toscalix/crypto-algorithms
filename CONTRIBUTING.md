...
* All the properties are described on the SPDX Cryptographic Algorithms List [properties description file](https://github.com/toscalix/crypto-algorithms/blob/docs-toscalix/docs/crypto-algorithms-list-properties-description.md)).
