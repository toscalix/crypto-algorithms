...
The release tooling follows the same governance model as the list itself. Proposed changes — whether bug fixes, new output formats, schema validation improvements, or automation updates — are first raised and discussed in GitHub issues in the working repository. A pull request is only opened once the proposed change has been discussed and considered mature. Changes do not mature in pull requests; they mature in issues. This keeps reviews focused and avoids requiring advanced Git skills from contributors who want to participate in the discussion without contributing code directly.
...
A proposed change is first raised as a GitHub issue in the working repository. The issue is where the change is described, discussed, and allowed to mature. Both asynchronous discussion — through comments in the issue — and synchronous discussion — in Cryptography Group meetings — happen with reference to the issue, and any conclusions or agreements reached in meetings are recorded there. A pull request is only created once the proposed change has been discussed, refined, and considered ready for formal review. Changes do not mature in pull requests; they mature in issues.
...
* Algorithm Inclusion Principles — The criteria used by the Cryptography Group to evaluate whether a candidate cryptographic algorithm is eligible for inclusion in SPDX CryptAlg. Maintained as algorithm-inclusion-principles.md in the docs/ folder of the working repository.
...
* CHANGELOG.md — The primary release documentation file, maintained in the root of the working repository. It contains the full release notes for every published version in reverse chronological order. It is the canonical source of release notes for SPDX CryptAlg.
...
* Deprecation — The process of marking an algorithm entry as no longer recommended for use in new SPDX documents, while retaining it in the list to preserve backward compatibility and traceability.
* Generation — The first component of the canonical version string. It starts at 1 and is incremented only when a breaking change is introduced.
...
* RELEASE-HISTORY.md — A compact Markdown table maintained in the root of the working repository, listing all published releases in reverse chronological order with their shortened version string and release date.
...
Documents in the working repository
* This release policy: docs/release-process.md
* Algorithm Inclusion Principles: docs/algorithm-inclusion-principles.md
* Properties description: docs/crypto-algorithms-list-properties-description.md
* Contributing guide: CONTRIBUTING.md
* Release history: RELEASE-HISTORY.md
* Release notes: CHANGELOG.md

Related SPDX projects
